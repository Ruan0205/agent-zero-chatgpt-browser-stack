...
class WhatsAppAutoReply(Extension):
    ...
    async def execute(self, loop_data: LoopData = LoopData(), **kwargs):
        ...
        override_set = bool(context.data.pop(CTX_WA_RESPONSE_OVERRIDE_SET, False))
        override_text = context.data.pop(CTX_WA_RESPONSE_OVERRIDE, "")
        response_text = override_text if override_set else _extract_last_response(context)
