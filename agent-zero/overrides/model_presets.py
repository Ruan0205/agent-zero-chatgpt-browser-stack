...
from plugins._model_config.api.model_override import _notify_model_override_changed, browser_model_is_locked
...
class ModelPresets(ApiHandler):
    async def process(self, input: dict, request: Request) -> dict | Response:
        ...
        if action == "get":
            ...
            locked_context = AgentContext.get(context_id) if context_id else None
            if locked_context and browser_model_is_locked(locked_context):
